...
} from "./chunk-FGYGSCVZ.js";
import {
  getListItemUtilityClass,
  listItemClasses_default
} from "./chunk-I6QVRLCE.js";
import {
  RowListContext_default
} from "./chunk-ZDM2CMEK.js";
import {
  ListSubheaderContext_default
} from "./chunk-QLML364F.js";
import "./chunk-GRDGWLZC.js";
import "./chunk-4BUN26V2.js";
import {
  styled_default,
  useSlot,
  useThemeProps
} from "./chunk-T2I7RYGZ.js";
import "./chunk-K2RO5O6C.js";
import "./chunk-BWLWWKFI.js";
...
var ListItem = React.forwardRef(function ListItem2(inProps, ref) {
  ...
  const group = React.useContext(GroupListContext_default);
  const listComponent = React.useContext(ComponentListContext_default);
  const row = React.useContext(RowListContext_default);
  const wrap = React.useContext(WrapListContext_default);
  const nesting = React.useContext(NestedListContext_default);
  const {
  ...
  return (0, import_jsx_runtime.jsx)(ListSubheaderContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime.jsx)(NestedListContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime2.jsxs)(SlotRoot, _extends({}, rootProps, {
        ...
        })), React.Children.map(children, (child, index) => React.isValidElement(child) ? React.cloneElement(child, _extends({}, index === 0 && {
          "data-first-child": ""
