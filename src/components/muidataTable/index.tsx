...
function Muidatatable() {
  ...
  const columns = [
    ...
    },
    {
      ...
      label: "Nationality",
      options: {
        customBodyRender: (value: any) => <>{value || "India"}</>,
        filter: true,
        sort: false,
      },
    },
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(response, "signin patients data");
